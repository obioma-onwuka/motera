...
class TransferSentNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->line('Your transfer has been processed successfully.')
            ->line('Amount: $'.$amount)
            ->line('Reference: '.$this->transaction->reference)
            ->line('Recipient account: '.$this->counterpartyAccount->account_number)
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'message' => 'Transfer sent: $'.number_format((float) $this->transaction->amount, 2),
        ];
    }
}
