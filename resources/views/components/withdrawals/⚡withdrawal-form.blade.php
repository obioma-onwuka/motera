...
<div class="space-y-6">
    <div class="bg-white rounded-3xl p-6 shadow-sm border border-brand-border">
        ...
        <form wire:submit="submit" class="space-y-5">
            <div>
                <label class="block text-sm font-semibold text-brand-text-primary mb-2">Amount to Withdraw (₦)</label>
                <input type="number" wire:model.blur="amount" class="block w-full px-4 py-4 rounded-2xl border-brand-border focus:ring-brand-primary focus:border-brand-primary" placeholder="Min 500.00">
            ...
            <div class="pt-2 border-t border-brand-border">
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block text-xs font-semibold text-brand-text-secondary mb-1">Bank Name</label>
                        <select wire:model="bank_name" class="block w-full px-4 py-3 rounded-xl border-brand-border focus:ring-brand-primary focus:border-brand-primary bg-white">
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-brand-text-secondary mb-1">Account Number</label>
                        <input type="text" wire:model="account_number" class="block w-full px-4 py-3 rounded-xl border-brand-border focus:ring-brand-primary focus:border-brand-primary" placeholder="10 Digits">
                        @error('account_number') <span class="text-xs text-brand-danger mt-1">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label class="block text-xs font-semibold text-brand-text-secondary mb-1">Account Name</label>
                        <input type="text" wire:model="account_name" class="block w-full px-4 py-3 rounded-xl border-brand-border focus:ring-brand-primary focus:border-brand-primary" placeholder="Full Name as it appears on bank">
